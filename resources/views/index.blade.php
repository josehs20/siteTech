        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    ...
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>alltechsistemas@alltech.com</small>
                </div>
            </div>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            <a href="index.html" class="navbar-brand p-0">
                <h3 class="m-0"><img width="50px" src="img/logo2.png" alt=""></i>&nbsp;&nbsp; All Tech Sistemas</h3>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Sites vinculados</a>
                        <div class="dropdown-menu m-0">
                            <a href="blog.html" class="dropdown-item">Dashboard (Consultas)</a>
                            <a href="detail.html" class="dropdown-item">Venda Externa</a>
                        </div>
                    </div>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Sistema de gestão empresarial</h5>
                            <h4 class="text-white text-uppercase mb-3 animated slideInDown">Simplifique a gestao da sua empresa
                                com um sistema eficiente e fácil de usar</h4>
                            ...
                            <a href="quote.html" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Saiba mais</a>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h4 class="text-white text-uppercase mb-3 animated slideInDown">Integre todas as suas lojas com nossa solução <h3 class="text-white text-uppercase mb-3 animated slideInDown">Multi Loja</h3></h4>
        ...
        <div class="container py-5 pt-lg-0">
            <div class="row gx-0">
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.5s">
                    <div class="bg-primary shadow d-flex align-items-center justify-content-center p-4" style="height: 150px;border-radius: 10px;">
                ...
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.7s">
                    <div class="bg-light shadow d-flex align-items-center justify-content-center p-4" style="height: 150px;border-radius: 10px;">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="row g-0 mb-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                            <h4 class="mb-3">Adequação fiscal</h4>
                            {{-- <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Controle de Estoque</h5> --}}
                        </div>
                    </div>
                    <p class="mb-4">Em conformidade com a legislação vigente, homolagado e autorizado pelo Confaz, compatível com a NF-e, NFC-e, PAF-ECF (Cupom Fiscal), MDF-e, SINTEGRA e SPED.</p>
                    <div class="row g-0 mb-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Suporte Técnico</h5>
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Controle de Estoque</h5>
                        </div>
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Gestão de Vendas</h5>
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Acompanhe seus resultados</h5>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.6s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">Dúvidas</h5>
                            <h4 class="text-primary mb-0">(22) 9999-9999</h4>
                        </div>
                    </div>
